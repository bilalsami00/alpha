...
// //       if (openMenuId !== null && menuRefs.current[openMenuId] && !menuRefs.current[openMenuId]?.contains(event.target as Node)) {
// //         setOpenMenuId(null);
// //       }
// //     }
...
// //       setAllUsers((prev) => prev.map((u) => (u.id === modal.user!.id ? { ...u, status: "restricted" } : u)));
...
// //       subtitle: "All your users currently have access to Alpha Arc. Restricted users will appear here.",
// //     },
// //     request: {
// //       title: "No Sales Requests Yet",
// //       subtitle: "Once a user applies for sales team access from the app, their request will appear here for your review.",
// //     },
// //   } as const;

// //   const salesHeaderStyles = {
// //     basePadding: { paddingTop: "12px", paddingRight: "16px", paddingBottom: "12px", paddingLeft: "16px" },
// //   } as const;
...
// //       {/* Tabs */}
// //       <div className="flex mb-6 sm:ml-6 sm:gap-4 w-auto md:max-w-[440px]" role="tablist" aria-label="User tabs">
// //         <button
// //           role="tab"
// //           aria-pressed={activeTab === "active"}
// //           onClick={() => { setActiveTab("active"); setCurrentPage(1); }}
// //           className={`flex-1 text-center whitespace-nowrap px-4 py-2 txt-12 font-medium border-b-2 ${activeTab === "active" ? "border-brand  bg-transparent text-[#333839]" : "border-transparent text-[#51595A]"}`}
// //         >
// //           Active Users
// //         </button>
// //         <button
...
// //           className={`flex-1 text-center whitespace-nowrap px-4 py-2 txt-12 font-medium border-b-2 ${activeTab === "restricted" ? "border-brand  bg-transparent text-[#333839]" : "border-transparent text-[#51595A]"}`}
// //         >
// //           Restricted Users
// //         </button>
// //         <button
...
// //           className={`flex-1 text-center whitespace-nowrap px-4 py-2 txt-12 font-medium border-b-2 ${activeTab === "request" ? "border-brand  bg-transparent text-[#333839]" : "border-transparent text-[#51595A]"}`}
// //         >
// //           Sales Tab Request
// //         </button>
// //       </div>
...
// //           type={modal.type!}
// //           user={modal.user}
// //           onCancel={() => setModal({ isOpen: false, type: null, user: null, action: null })}
...
//       if (user.status === "restricted") {
//         setAllUsers((prev) => prev.map((u) => (u.id === user.id ? { ...u, status: "active" } : u)));
//         showToast(`${user.name} has been unrestricted.`, "success");
//         return;
//       }
//       setModal({ isOpen: true, type: "restrict", user, action: "restrict" });
//       return;
...
//     setAllUsers((prev) => prev.filter((u) => u.id !== userId));
//     closeViewModal();
//     showToast(`Sales request rejected.`, "info");
//   };
//   const handleAddToSalesTeam = (userId: number, team?: string | null) => {
//     setAllUsers((prev) => prev.map((u) => (u.id === userId ? { ...u, status: "active" } : u)));
//     closeViewModal();
//     showToast(`User added to sales team: ${team ?? "Default"}`, "success");
//   };
