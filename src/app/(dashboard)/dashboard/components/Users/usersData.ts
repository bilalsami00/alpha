...
export const INITIAL_USERS: User[] = [
  ...
  //   // ... copy the rest of your initial users here (ids 2..40)
  //   { id: 14, name: "Elizabeth Lewis", email: "elizabeth.l@example.com", status: "request", phone: "+92 300 1234567", salesReason: "I want to join sales because I enjoy client interaction ..." },
  //   // etc.
  {
    id: 1,
    name: "John Doe",
